    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 mb-6">
        <div class="flex overflow-x-auto scrollbar-hide">
            <button @click="activeTab = 'company'" 
                    :class="activeTab === 'company' ? 'border-indigo-600 text-indigo-600 bg-indigo-50' : 'border-transparent text-gray-500 hover:text-gray-700'"
            ...
            <button @click="activeTab = 'payment'" 
                    :class="activeTab === 'payment' ? 'border-indigo-600 text-indigo-600 bg-indigo-50' : 'border-transparent text-gray-500 hover:text-gray-700'"
                    class="flex items-center px-6 py-4 border-b-2 font-medium text-sm whitespace-nowrap transition-colors">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button @click="activeTab = 'templates'" 
                    :class="activeTab === 'templates' ? 'border-indigo-600 text-indigo-600 bg-indigo-50' : 'border-transparent text-gray-500 hover:text-gray-700'"
                    class="flex items-center px-6 py-4 border-b-2 font-medium text-sm whitespace-nowrap transition-colors">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button @click="activeTab = 'security'" 
                    :class="activeTab === 'security' ? 'border-indigo-600 text-indigo-600 bg-indigo-50' : 'border-transparent text-gray-500 hover:text-gray-700'"
                    class="flex items-center px-6 py-4 border-b-2 font-medium text-sm whitespace-nowrap transition-colors">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div x-show="activeTab === 'payment'" x-cloak>
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 bg-gradient-to-r from-amber-50 to-orange-50 border-b border-gray-100">
                    ...
                    <p class="text-sm text-gray-500">Ajoutez vos numéros pour recevoir des paiements via Mobile Money</p>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Wave -->
                        <div class="p-5 bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl border-2 border-cyan-200">
                            <div class="flex items-center mb-4">
                                <div class="w-12 h-12 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-xl flex items-center justify-center text-white text-2xl shadow-lg">
                                    🌊
                                </div>
                                <div class="ml-4">
                            ...
                            <input type="tel" name="wave_number" value="{{ old('wave_number', auth()->user()->wave_number) }}"
                        ...
                        <!-- Orange Money -->
                        <div class="p-5 bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl border-2 border-orange-200">
                            <div class="flex items-center mb-4">
                                <div class="w-12 h-12 bg-gradient-to-br from-orange-400 to-amber-500 rounded-xl flex items-center justify-center text-white text-2xl shadow-lg">
                                    🍊
                                </div>
                                <div class="ml-4">
                            ...
                            <input type="tel" name="orange_money_number" value="{{ old('orange_money_number', auth()->user()->orange_money_number) }}"
                        ...
                        <!-- MTN MoMo -->
                        <div class="p-5 bg-gradient-to-br from-yellow-50 to-amber-50 rounded-xl border-2 border-yellow-300">
                            <div class="flex items-center mb-4">
                                <div class="w-12 h-12 bg-gradient-to-br from-yellow-400 to-amber-500 rounded-xl flex items-center justify-center text-white text-2xl shadow-lg">
                                    📱
                                </div>
                                <div class="ml-4">
                            ...
                            <input type="tel" name="momo_number" value="{{ old('momo_number', auth()->user()->momo_number) }}"
                        ...
                        <div class="p-5 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border-2 border-blue-200">
                            <div class="flex items-center mb-4">
                                <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center text-white text-2xl shadow-lg">
                                    📲
                                </div>
                                <div class="ml-4">
                            ...
                            <input type="tel" name="moov_money_number" value="{{ old('moov_money_number', auth()->user()->moov_money_number) }}"
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-indigo-800">
                                    ...
                                    Vos numéros de paiement mobile apparaîtront sur vos factures PDF avec un <strong>QR code</strong>. 
                                    Vos clients pourront scanner ce QR code ou utiliser ces numéros pour vous payer directement.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    @php
                        ...
                        $currentTemplate = auth()->user()->invoice_template ?? 'starter';
                    @endphp

                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <!-- Template Starter -->
                        <label class="relative cursor-pointer group">
                            <input type="radio" name="invoice_template" value="starter" class="sr-only peer"
                                   {{ $currentTemplate === 'starter' ? 'checked' : '' }}>
                            <div class="p-4 border-2 rounded-2xl transition-all duration-200 peer-checked:border-indigo-500 peer-checked:bg-indigo-50 border-gray-200 hover:border-gray-300">
                                <div class="aspect-[3/4] bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl mb-4 flex items-center justify-center">
                                    <span class="text-4xl">📄</span>
                                </div>
                                <h3 class="font-semibold text-gray-900">Classique</h3>
                                <p class="text-xs text-gray-500 mt-1">Design simple et professionnel</p>
                                <span class="inline-block mt-2 px-2 py-1 text-xs bg-gray-100 text-gray-600 rounded-full">Gratuit</span>
                            </div>
                            <div class="absolute top-4 right-4 w-6 h-6 rounded-full border-2 border-gray-300 peer-checked:border-indigo-500 peer-checked:bg-indigo-500 flex items-center justify-center transition-all">
                        ...
                        <!-- Template Pro -->
                        <label class="relative cursor-pointer group {{ !in_array($plan, ['pro', 'enterprise']) ? 'opacity-60' : '' }}">
                            <input type="radio" name="invoice_template" value="pro" class="sr-only peer"
                                   {{ $currentTemplate === 'pro' ? 'checked' : '' }}
                                   {{ !in_array($plan, ['pro', 'enterprise']) ? 'disabled' : '' }}>
                            <div class="p-4 border-2 rounded-2xl transition-all duration-200 peer-checked:border-indigo-500 peer-checked:bg-indigo-50 border-gray-200 hover:border-gray-300">
                                <div class="aspect-[3/4] bg-gradient-to-br from-indigo-400 to-purple-500 rounded-xl mb-4 flex items-center justify-center relative overflow-hidden">
                                    <div class="absolute top-2 right-2 w-8 h-8 bg-white/20 rounded-lg"></div>
                                    <div class="absolute bottom-4 left-4 right-4 h-2 bg-white/30 rounded"></div>
                                    <span class="text-4xl">✨</span>
                                </div>
                                <h3 class="font-semibold text-gray-900">Pro Moderne</h3>
                                <p class="text-xs text-gray-500 mt-1">Dégradés + QR code paiement</p>
                                <span class="inline-block mt-2 px-2 py-1 text-xs bg-indigo-100 text-indigo-700 rounded-full">Pro</span>
                            </div>
                        ...
                        <!-- Template Enterprise -->
                        <label class="relative cursor-pointer group {{ $plan !== 'enterprise' ? 'opacity-60' : '' }}">
                            <input type="radio" name="invoice_template" value="enterprise" class="sr-only peer"
                                   {{ $currentTemplate === 'enterprise' ? 'checked' : '' }}
                                   {{ $plan !== 'enterprise' ? 'disabled' : '' }}>
                            <div class="p-4 border-2 rounded-2xl transition-all duration-200 peer-checked:border-indigo-500 peer-checked:bg-indigo-50 border-gray-200 hover:border-gray-300">
                                <div class="aspect-[3/4] bg-gradient-to-br from-emerald-400 via-cyan-500 to-purple-500 rounded-xl mb-4 flex items-center justify-center relative overflow-hidden">
                                    <div class="absolute top-0 right-0 w-16 h-16 bg-white/10 rounded-full -mr-8 -mt-8"></div>
                                    <div class="absolute bottom-0 left-0 w-12 h-12 bg-white/10 rounded-full -ml-6 -mb-6"></div>
                                    <span class="text-4xl">🏆</span>
                                </div>
                                <h3 class="font-semibold text-gray-900">Enterprise Premium</h3>
                                <p class="text-xs text-gray-500 mt-1">Design premium + Montant en lettres</p>
                                <span class="inline-block mt-2 px-2 py-1 text-xs bg-emerald-100 text-emerald-700 rounded-full">Enterprise</span>
                            </div>
                            @if($plan !== 'enterprise')
                            <div class="absolute inset-0 flex items-center justify-center bg-white/80 rounded-2xl">
                                <span class="px-4 py-2 bg-emerald-600 text-white text-sm rounded-lg">
                    ...
                    <div class="mt-6 p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl border border-indigo-200">
                        <div class="flex items-center justify-between">
                            <div>
                                <h4 class="font-semibold text-gray-900">Débloquez plus de templates !</h4>
                                <p class="text-sm text-gray-600">Passez à Pro pour accéder aux designs modernes avec QR code</p>
                            </div>
                            <a href="{{ route('register') }}" class="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:shadow-lg transition-all">
                                Voir les plans
                            </a>
                        </div>
                    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="px-6 py-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-100">
                        ...
                        <p class="text-sm text-gray-500">Sécurisez votre compte avec une vérification supplémentaire</p>
                    </div>
                    <div class="p-6">
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Cette action est irréversible. Toutes vos données seront supprimées.</p>
                            </div>
                            <button type="button" class="px-4 py-2 bg-red-600 text-white rounded-xl hover:bg-red-700 transition-colors">
                                Supprimer
                            </button>
                        </div>
                    </div>
