...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <!-- Form -->
    <form action="{{ route('client.products.update', $product) }}" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-200 divide-y divide-gray-200">
        @csrf
        @method('PUT')
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-2 gap-4" x-data="{ type: '{{ old('type', $product->type) }}' }">
