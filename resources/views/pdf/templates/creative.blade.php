...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { display: table; width: 100%; margin-top: -80px; margin-bottom: 30px; }
        ...
        .invoice-title { font-size: 32px; font-weight: 800; color: #1f2937; letter-spacing: -1px; }
        ...
        .status-badge { display: inline-block; padding: 6px 16px; border-radius: 20px; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; margin-top: 10px; }
        ...
        .status-sent { background: linear-gradient(135deg, #EC4899, #BE185D); color: #fff; }
        
        .info-section { display: table; width: 100%; margin-bottom: 30px; }
        .info-card { display: table-cell; width: 48%; vertical-align: top; background: #FDF2F8; border-radius: 16px; padding: 20px; }
        .info-card h3 { font-size: 10px; color: #EC4899; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 12px; font-weight: 700; }
        .info-card .name { font-size: 16px; font-weight: 700; color: #1f2937; margin-bottom: 8px; }
        .info-card p { font-size: 11px; color: #6b7280; margin: 3px 0; }
        
        .dates-info { display: table; width: 100%; margin-top: 15px; background: #fff; border-radius: 10px; padding: 12px; }
        .date-item { display: table-cell; width: 50%; text-align: center; }
        .date-item .label { font-size: 9px; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.5px; }
        .date-item .value { font-size: 13px; font-weight: 700; color: #1f2937; margin-top: 3px; }
        
        .items-table { width: 100%; border-collapse: collapse; margin-bottom: 25px; border-radius: 16px; overflow: hidden; }
        .items-table thead { background: linear-gradient(135deg, #EC4899, #BE185D); }
        .items-table th { padding: 14px 12px; text-align: left; font-weight: 600; font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px; color: #fff; }
        .items-table td { padding: 14px 12px; border-bottom: 1px solid #f1f5f9; font-size: 11px; }
        .items-table tbody tr:nth-child(even) { background: #FDF2F8; }
        ...
        .payment-section { display: table-cell; width: 55%; vertical-align: top; padding-right: 20px; }
        .totals-section { display: table-cell; width: 45%; vertical-align: top; }
        
        .payment-box { background: linear-gradient(135deg, #FDF2F8 0%, #FCE7F3 100%); border-radius: 16px; padding: 20px; border: 2px solid #F472B6; }
        .payment-box h4 { font-size: 12px; font-weight: 700; color: #BE185D; margin-bottom: 15px; }
        .payment-method { background: #fff; border-radius: 8px; padding: 8px 12px; margin-bottom: 8px; display: table; width: 100%; }
        .payment-method-icon { display: table-cell; width: 30px; vertical-align: middle; }
        .payment-method-info { display: table-cell; vertical-align: middle; }
        .payment-method-name { font-size: 10px; font-weight: 700; color: #1f2937; }
        .payment-method-number { font-size: 12px; font-weight: 600; color: #EC4899; font-family: monospace; }
        
        .totals-box { background: #FDF2F8; border-radius: 16px; padding: 20px; }
        .totals-row { display: table; width: 100%; margin-bottom: 8px; }
        .totals-row .label { display: table-cell; text-align: left; font-size: 11px; color: #6b7280; }
        .totals-row .value { display: table-cell; text-align: right; font-size: 11px; color: #1f2937; font-weight: 500; }
        .totals-row.total { margin-top: 12px; padding-top: 12px; border-top: 2px dashed #F472B6; }
        .totals-row.total .label { font-size: 14px; font-weight: 700; color: #1f2937; }
        .totals-row.total .value { font-size: 20px; font-weight: 800; color: #EC4899; }
        
        .notes { margin-top: 25px; padding: 16px; background: #FDF2F8; border-radius: 12px; border-left: 4px solid #EC4899; }
        .notes h4 { font-size: 10px; font-weight: 700; color: #EC4899; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 8px; }
        .notes p { font-size: 11px; color: #4b5563; }
        
        .footer { margin-top: 40px; text-align: center; padding: 20px; background: linear-gradient(135deg, #EC4899, #BE185D); border-radius: 16px; color: #fff; }
