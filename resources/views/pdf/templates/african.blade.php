        ...
        * {
        ...
        .african-banner {
            ...
            background: repeating-linear-gradient(90deg,
                    ...
                    #16A34A 40px, #16A34A 60px,
                    #1F2937 60px, #1F2937 80px);
        }
        ...
        .african-banner-bottom {
            height: 10px;
            background: repeating-linear-gradient(90deg,
                    #DC2626 0px, #DC2626 15px,
                    #F59E0B 15px, #F59E0B 30px,
                    #16A34A 30px, #16A34A 45px,
                    #1F2937 45px, #1F2937 60px);
        }
    </style>
</head>
...
<body>
    <div class="page">
        <div class="african-banner"></div>
        <div class="african-bar-thin"></div>
        ...
        <div class="container">
                    ...
                    <div class="brand">
                        <div class="brand-logo">
                            <div class="brand-logo-box">
                                {{ strtoupper(substr($invoice->user->company_name ?? ($invoice->user->name ?? 'A'), 0, 2)) }}
                            </div>
                        </div>
                        <div class="brand-info">
                            <div class="brand-name">
                                {{ $invoice->user->company_name ?? ($invoice->user->name ?? config('app.name')) }}</div>
                            <div class="brand-tagline">🌍 Made in Africa</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer">
                <div class="footer-content">
                    ...
                    <div class="footer-badge">🌍 Fièrement Africain</div>
                </div>
            </div>
        </div>

        <div class="african-banner-bottom"></div>
    </div>
</body>
