...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0">
            <a href="<?php echo e(route('client.clients.create')); ?>" 
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center">
                                    <span class="text-sm font-medium text-purple-600"><?php echo e(strtoupper(substr($client->name, 0, 2))); ?></span>
                                </div>
                                <div class="ml-4">
                                    ...
                                    <div class="text-sm text-gray-500"><?php echo e($client->company); ?></div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                <?php echo e($client->invoices_count ?? 0); ?> facture(s)
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e(number_format($client->invoices_sum_total ?? 0, 0, ',', ' ')); ?> XOF
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-2">
                                <a href="<?php echo e(route('client.clients.show', $client)); ?>" 
                                   class="text-blue-600 hover:text-blue-900">
                                    Voir
                                </a>
                                <a href="<?php echo e(route('client.clients.edit', $client)); ?>" 
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/teya2023/Downloads/invoice-saas-starter/resources/views/dashboard/clients/index.blade.php ENDPATH**/ ?>