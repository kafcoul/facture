<?php $__env->startSection('title', 'Facturation & Abonnement'); ?>
...
<?php $__env->startSection('content'); ?>
    <div x-data="billingPage()" class="space-y-8">
                ...
                <div class="relative flex items-start space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="mt-1 text-sm text-amber-700">
                            Il vous reste <span class="font-bold text-amber-900"><?php echo e($trialDaysRemaining); ?>

                                jour<?php echo e($trialDaysRemaining > 1 ? 's' : ''); ?></span>
                            d'essai gratuit sur le plan <span
                                class="font-semibold"><?php echo e($plans[$currentPlan]['name']); ?></span>.
                        ...
                        <div class="mt-3">
                            <div class="w-full bg-amber-200 rounded-full h-2">
                                ...
                                <div class="bg-amber-500 h-2 rounded-full transition-all"
                                    style="width: <?php echo e($trialProgress); ?>%"></div>
                            </div>
                            <p class="mt-1 text-xs text-amber-600"><?php echo e(round($trialProgress)); ?>% de la période d'essai
                                écoulée</p>
                        </div>
                    </div>
                </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isTrialExpired): ?>
                    ...
                    <div class="flex-1">
                        ...
                        <p class="mt-1 text-sm text-red-700">
                            Votre période d'essai du plan <span
                                class="font-semibold"><?php echo e($plans[$currentPlan]['name']); ?></span> a expiré.
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1 bg-white rounded-xl border border-gray-200 p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentPlan !== 'starter'): ?>
                        <span
                            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
                    <?php echo e($currentPlan === 'enterprise' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700'); ?>">
                            <?php echo e($plans[$currentPlan]['name']); ?>
                ...
                <div class="text-center py-6 border-t border-gray-100">
                    <div class="text-4xl font-bold text-gray-900">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plans[$currentPlan]['price'] === 0): ?>
                            Gratuit
                        <?php else: ?>
                            <?php echo e(number_format($plans[$currentPlan]['price'], 0, ',', ' ')); ?>

                            <span class="text-lg font-normal text-gray-500">XOF/mois</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <p class="mt-2 text-sm text-gray-500"><?php echo e($plans[$currentPlan]['description']); ?></p>
                </div>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentPlan !== 'starter'): ?>
                    <div class="pt-4 border-t border-gray-100">
                        <form method="POST" action="<?php echo e(route('client.billing.cancel')); ?>"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <span class="text-sm text-gray-500">
                                <?php echo e($invoiceUsage); ?> / <?php echo e($invoiceLimit === -1 ? '∞' : $invoiceLimit); ?>

                            </span>
                        </div>
                        <div class="w-full bg-gray-100 rounded-full h-2.5">
                            <div class="h-2.5 rounded-full transition-all <?php echo e($invoicePercent >= 90 ? 'bg-red-500' : ($invoicePercent >= 70 ? 'bg-amber-500' : 'bg-blue-500')); ?>"
                                style="width: <?php echo e($invoiceLimit === -1 ? 5 : $invoicePercent); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <span class="text-sm text-gray-500">
                                <?php echo e($clientUsage); ?> / <?php echo e($clientLimit === -1 ? '∞' : $clientLimit); ?>

                            </span>
                        </div>
                        <div class="w-full bg-gray-100 rounded-full h-2.5">
                            <div class="h-2.5 rounded-full transition-all <?php echo e($clientPercent >= 90 ? 'bg-red-500' : ($clientPercent >= 70 ? 'bg-amber-500' : 'bg-green-500')); ?>"
                                style="width: <?php echo e($clientLimit === -1 ? 5 : $clientPercent); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <span class="text-sm text-gray-500">
                                <?php echo e($productUsage); ?> / <?php echo e($productLimit === -1 ? '∞' : $productLimit); ?>

                            </span>
                        </div>
                        <div class="w-full bg-gray-100 rounded-full h-2.5">
                            <div class="h-2.5 rounded-full transition-all <?php echo e($productPercent >= 90 ? 'bg-red-500' : ($productPercent >= 70 ? 'bg-amber-500' : 'bg-purple-500')); ?>"
                                style="width: <?php echo e($productLimit === -1 ? 5 : $productPercent); ?>%"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <?php echo e($planKey === $currentPlan ? 'border-blue-500 shadow-lg shadow-blue-500/10' : 'border-gray-200 hover:border-gray-300'); ?>

                <?php echo e($planKey === 'pro' && $planKey !== $currentPlan ? 'ring-2 ring-blue-500 ring-offset-2' : ''); ?>">

                        <!-- Badge recommandé -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($planKey === 'pro' && $planKey !== $currentPlan): ?>
                        ...
                        <!-- Badge plan actuel -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($planKey === $currentPlan): ?>
                            <div class="absolute -top-4 left-1/2 -translate-x-1/2">
                                <span
                        ...
                        <div class="p-8">
                            ...
                            <div class="text-center mb-8">
                                ...
                                <div class="mt-6">
                                    ...
                                    <?php else: ?>
                                        <span
                                            class="text-4xl font-bold text-gray-900"><?php echo e(number_format($plan['price'], 0, ',', ' ')); ?></span>
                            ...
                            <div class="space-y-3 mb-8">
                                <div class="flex items-center text-sm">
                                    ...
                                    <span class="text-gray-700">
                                        <?php echo e($plan['limits']['invoices_per_month'] === -1 ? 'Factures illimitées' : $plan['limits']['invoices_per_month'] . ' factures/mois'); ?>
                                ...
                                <div class="flex items-center text-sm">
                                    ...
                                    <span class="text-gray-700">
                                        <?php echo e($plan['limits']['clients'] === -1 ? 'Clients illimités' : $plan['limits']['clients'] . ' clients'); ?>
                                ...
                                <div class="flex items-center text-sm">
                                    ...
                                    <span class="text-gray-700">
                                        <?php echo e($plan['limits']['products'] === -1 ? 'Produits illimités' : $plan['limits']['products'] . ' produits'); ?>
                                ...
                                <div class="flex items-center text-sm">
                                    ...
                                    <span
                                        class="text-gray-700"><?php echo e($plan['limits']['storage_mb'] >= 1000 ? $plan['limits']['storage_mb'] / 1000 . ' Go' : $plan['limits']['storage_mb'] . ' Mo'); ?>
                            ...
                            <div class="space-y-3 mb-8 pt-6 border-t border-gray-100">
                                ...
                                ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $featureLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featureKey => $featureLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center text-sm">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plan['features'][$featureKey] ?? false): ?>
                                            ...
                                            <span class="text-gray-700"><?php echo e($featureLabel); ?></span>
                                        <?php else: ?>
                                            ...
                                            <span class="text-gray-400"><?php echo e($featureLabel); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                            ...
                            <div class="mb-8 pt-4 border-t border-gray-100">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $plan['limits']['payment_gateways'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span
                                            class="inline-flex items-center px-2 py-1 text-xs rounded-md bg-gray-100 text-gray-600">
                                            <?php echo e($gatewayLabels[$gateway] ?? ucfirst($gateway)); ?>
                            ...
                            <div>
                                ...
                                <?php elseif(\App\Services\PlanService::isUpgrade($currentPlan, $planKey)): ?>
                                    ...
                                    <?php echo e($planKey === 'pro' ? 'bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30' : 'bg-purple-600 hover:bg-purple-700 shadow-lg shadow-purple-500/25 hover:shadow-xl hover:shadow-purple-500/30'); ?>">
                                            🚀 Passer au <?php echo e($plan['name']); ?>

                                        </button>
                                    </form>
                                <?php else: ?>
                                    <form method="POST" action="<?php echo e(route('client.billing.downgrade')); ?>"
                                        onsubmit="return confirm('Êtes-vous sûr de vouloir rétrograder vers le plan <?php echo e($plan['name']); ?> ? Certaines fonctionnalités ne seront plus disponibles.')">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="plan" value="<?php echo e($planKey); ?>">
                                        <button type="submit"
                                            ...
                                            Rétrograder vers <?php echo e($plan['name']); ?>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b border-gray-200">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planKey => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <th
                                    class="px-6 py-4 text-center text-sm font-semibold <?php echo e($planKey === $currentPlan ? 'text-blue-700 bg-blue-50' : 'text-gray-900'); ?>">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planKey => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td
                                    class="px-6 py-3.5 text-sm text-center <?php echo e($planKey === $currentPlan ? 'bg-blue-50 font-semibold text-blue-700' : 'text-gray-900'); ?>">
                                    <?php echo e($plan['limits']['invoices_per_month'] === -1 ? 'Illimité' : $plan['limits']['invoices_per_month']); ?>
                        ...
                        <tr>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planKey => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td
                                    class="px-6 py-3.5 text-sm text-center <?php echo e($planKey === $currentPlan ? 'bg-blue-50 font-semibold text-blue-700' : 'text-gray-900'); ?>">
                                    <?php echo e($plan['limits']['clients'] === -1 ? 'Illimité' : $plan['limits']['clients']); ?>
                        ...
                        <tr>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planKey => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td
                                    class="px-6 py-3.5 text-sm text-center <?php echo e($planKey === $currentPlan ? 'bg-blue-50 font-semibold text-blue-700' : 'text-gray-900'); ?>">
                                    <?php echo e($plan['limits']['products'] === -1 ? 'Illimité' : $plan['limits']['products']); ?>
                        ...
                        <tr>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planKey => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td
                                    class="px-6 py-3.5 text-sm text-center <?php echo e($planKey === $currentPlan ? 'bg-blue-50 font-semibold text-blue-700' : 'text-gray-900'); ?>">
                                    <?php echo e($plan['limits']['team_members']); ?>
                        ...
                        <tr>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planKey => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td
                                    class="px-6 py-3.5 text-sm text-center <?php echo e($planKey === $currentPlan ? 'bg-blue-50 font-semibold text-blue-700' : 'text-gray-900'); ?>">
                                    <?php echo e($plan['limits']['storage_mb'] >= 1000 ? $plan['limits']['storage_mb'] / 1000 . ' Go' : $plan['limits']['storage_mb'] . ' Mo'); ?>
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $comparisonFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featureKey => $featureLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="px-8 py-3.5 text-sm text-gray-700"><?php echo e($featureLabel); ?></td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planKey => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td
                                        class="px-6 py-3.5 text-center <?php echo e($planKey === $currentPlan ? 'bg-blue-50' : ''); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plan['features'][$featureKey] ?? false): ?>
                        ...
                        <tr>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planKey => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td
                                    class="px-6 py-3.5 text-sm text-center <?php echo e($planKey === $currentPlan ? 'bg-blue-50 font-semibold text-blue-700' : 'text-gray-900'); ?>">
                                    <?php echo e(count($plan['limits']['payment_gateways'])); ?>

                                    passerelle<?php echo e(count($plan['limits']['payment_gateways']) > 1 ? 's' : ''); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/teya2023/Downloads/invoice-saas-starter/resources/views/dashboard/billing/index.blade.php ENDPATH**/ ?>