    ...
    <div class="mb-8">
        ...
        <div class="mt-6 flex items-center space-x-4">
            <div class="flex-1 flex items-center">
                ...
                <span class="ml-2 text-sm font-medium" :class="step >= 1 ? 'text-indigo-600' : 'text-gray-500'">Client</span>
            </div>
            ...
            <div class="flex-1 flex items-center">
                ...
                <span class="ml-2 text-sm font-medium" :class="step >= 2 ? 'text-indigo-600' : 'text-gray-500'">Articles</span>
            </div>
            ...
            <div class="flex-1 flex items-center">
                ...
                <span class="ml-2 text-sm font-medium" :class="step >= 3 ? 'text-indigo-600' : 'text-gray-500'">Finaliser</span>
            </div>
        </div>
    </div>

    <form action="<?php echo e(route('client.invoices.store')); ?>" method="POST" @submit="validateForm">
        <?php echo csrf_field(); ?>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-md"
                    ...
                    <div class="p-6">
                        <div class="relative">
                            <div class="relative">
                                <input type="text" 
                                       ...
                                       @focus="showClientDropdown = true; step = 1"
                                       @input="filterClients()"
                            ...
                            <!-- Dropdown clients -->
                            <div x-show="showClientDropdown && filteredClients.length > 0" 
                                 x-cloak
                                ...
                                <template x-for="client in filteredClients" :key="client.id">
                                    <button type="button"
                                        ...
                                        <div class="flex-shrink-0">
                                            <span class="text-xs px-2 py-1 rounded-full bg-green-100 text-green-700" x-text="client.invoices_count + ' factures'"></span>
                                        </div>
                                    </button>
                                </template>
                            </div>
                            ...
                            <div x-show="showClientDropdown && clientSearch.length > 0 && filteredClients.length === 0" 
                                ...
                                <button type="button" @click="openNewClientModal()" class="mt-4 inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors">
                        ...
                        <div x-show="!selectedClient" class="mt-4 text-center">
                            <button type="button" @click="openNewClientModal()" class="inline-flex items-center text-indigo-600 hover:text-indigo-700 font-medium">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-md"
                    ...
                    <div class="px-6 py-4 bg-gradient-to-r from-green-50 to-emerald-50 border-b border-gray-100">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm text-gray-500" x-text="items.length + ' article(s)'"></span>
                        </div>
                    </div>
                    <div class="p-6">
                        <!-- Liste des articles -->
                        <div class="space-y-4">
                            <template x-for="(item, index) in items" :key="item.key">
                                <div class="group relative p-5 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200 hover:border-indigo-300 hover:bg-indigo-50/30 transition-all duration-200"
                                     @click="step = 2"
                                    ...
                                    <!-- Numéro d'article -->
                                    <div class="absolute -top-3 -left-3 w-8 h-8 rounded-full bg-indigo-600 text-white flex items-center justify-center text-sm font-bold shadow-lg"
                                         x-text="index + 1"></div>
                                    ...
                                    <button type="button" 
                                            ...
                                            class="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-red-500 text-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200 hover:bg-red-600 shadow-lg">
                                    ...
                                    <div class="grid grid-cols-12 gap-4">
                                        ...
                                        <div class="col-span-12 lg:col-span-5">
                                            <label class="block text-xs font-medium text-gray-500 mb-1">Produit / Description</label>
                                            <div class="relative">
                                                <select :name="'items[' + index + '][product_id]'"
                                                        x-model="item.product_id"
                                                        @change="updateItemFromProduct(index)"
                                                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl text-gray-900 bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 appearance-none cursor-pointer">
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($product->id); ?>" 
                                                            ...
                                                            <?php echo e($product->name); ?> - <?php echo e(number_format($product->price, 0, ',', ' ')); ?> XOF
                                                        </option>
                                        ...
                                        <div class="col-span-4 lg:col-span-2">
                                            ...
                                            <div class="flex items-center">
                                                <button type="button" @click="decrementQty(index)" class="p-2 bg-gray-100 rounded-l-xl hover:bg-gray-200 transition-colors">
                                                ...
                                                <input type="number" 
                                                       ...
                                                       min="1"
                                                       class="w-full px-2 py-3 border-y-2 border-gray-200 text-center text-gray-900 font-medium bg-white focus:ring-0 focus:border-indigo-500">
                                                <button type="button" @click="incrementQty(index)" class="p-2 bg-gray-100 rounded-r-xl hover:bg-gray-200 transition-colors">
                                                    <svg class="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                                                    </svg>
                                                </button>
                                        ...
                                        <!-- Prix unitaire -->
                                        <div class="col-span-4 lg:col-span-2">
                                            <label class="block text-xs font-medium text-gray-500 mb-1">Prix unitaire</label>
                                            <div class="relative">
                                                <input type="number" 
                                                       ...
                                                       @input="calculateTotals()"
                                                       placeholder="0"
                                                       class="w-full pl-4 pr-16 py-3 border-2 border-gray-200 rounded-xl text-gray-900 font-medium bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                                <span class="absolute inset-y-0 right-0 pr-3 flex items-center text-xs font-medium text-gray-400">XOF</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-span-4 lg:col-span-1">
                                            ...
                                            <div class="relative">
                                                <input type="number" 
                                                       ...
                                                       min="0" max="100"
                                                       placeholder="18"
                                                       class="w-full pl-4 pr-8 py-3 border-2 border-gray-200 rounded-xl text-gray-900 font-medium bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                                <span class="absolute inset-y-0 right-0 pr-3 flex items-center text-xs font-medium text-gray-400">%</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-span-12 lg:col-span-2">
                                            ...
                                            <div class="px-4 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl text-white text-center font-bold"
                        ...
                        <button type="button" 
                                @click="addItem()"
                                class="mt-6 w-full py-4 border-2 border-dashed border-gray-300 rounded-xl text-gray-500 hover:border-indigo-500 hover:text-indigo-600 hover:bg-indigo-50 transition-all duration-200 flex items-center justify-center group">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $products->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button type="button" 
                                        @click="quickAddProduct(<?php echo e($product->id); ?>, '<?php echo e($product->name); ?>', <?php echo e($product->price); ?>, <?php echo e($product->tax_rate ?? 18); ?>)"
                                        class="px-3 py-1.5 text-xs bg-gray-100 hover:bg-indigo-100 hover:text-indigo-700 rounded-full transition-colors">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-md"
                    ...
                    <div class="p-6 space-y-6" @click="step = 3">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex bg-gray-100 rounded-xl p-1">
                                    <button type="button" 
                                            @click="discountType = 'percentage'; calculateTotals()"
                                            :class="discountType === 'percentage' ? 'bg-white shadow text-indigo-600' : 'text-gray-500'"
                                            class="px-4 py-2 rounded-lg font-medium transition-all duration-200">
                                        %
                                    </button>
                                    <button type="button" 
                                            @click="discountType = 'fixed'; calculateTotals()"
                                            :class="discountType === 'fixed' ? 'bg-white shadow text-indigo-600' : 'text-gray-500'"
                                            class="px-4 py-2 rounded-lg font-medium transition-all duration-200">
                                        XOF
                                    </button>
                                </div>
                        ...
                        <div>
                            ...
                            <textarea name="notes" 
                                      rows="3"
                                      placeholder="Informations supplémentaires pour votre client..."
                ...
                <div class="sticky top-6 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="flex justify-between items-center py-2" x-show="discountAmount > 0">
                                ...
                                <span class="font-medium text-red-500" x-text="'-' + formatCurrency(discountAmount)"></span>
                            </div>
                            
                            <div class="border-t border-gray-100 pt-4">
                                <div class="flex justify-between items-center">
                                    <span class="text-lg font-semibold text-gray-900">Total</span>
                                    <span class="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent" x-text="formatCurrency(total)"></span>
                                </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <button type="submit" 
                                ...
                                :class="(!selectedClient || items.length === 0) ? 'opacity-50 cursor-not-allowed' : 'hover:shadow-lg hover:scale-[1.02]'"
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-gray-600">
                                    <strong>Astuce :</strong> Vous pouvez sauvegarder votre facture en brouillon et la modifier plus tard.
                                </p>
                            </div>
                        </div>
                    </div>
...
<div x-data="{ open: false }" 
    ...
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="relative bg-white rounded-2xl shadow-xl max-w-md w-full p-6 transform transition-all"
            ...
            <form action="<?php echo e(route('client.clients.store')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="redirect_back" value="1">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Nom complet *</label>
                    <input type="text" name="name" required class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Email *</label>
                    <input type="email" name="email" required class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Téléphone</label>
                    <input type="tel" name="phone" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Adresse</label>
                    <textarea name="address" rows="2" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 resize-none"></textarea>
                </div>
                <div class="flex space-x-3 pt-4">
                    <button type="button" @click="open = false" class="flex-1 py-3 bg-gray-100 text-gray-700 font-medium rounded-xl hover:bg-gray-200 transition-colors">
                        Annuler
                    </button>
                    <button type="submit" class="flex-1 py-3 bg-indigo-600 text-white font-medium rounded-xl hover:bg-indigo-700 transition-colors">
                        Créer
                    </button>
                </div>
            </form>
...
function invoiceCreator() {
    return {
        ...
        // Articles
        items: [
            { key: Date.now(), product_id: '', description: '', quantity: 1, unit_price: 0, tax_rate: 18 }
        ],
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/teya2023/Downloads/invoice-saas-starter/resources/views/dashboard/invoices/create.blade.php ENDPATH**/ ?>