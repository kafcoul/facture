    ...
    <div class="relative min-h-[calc(100vh-72px)] overflow-hidden">
        ...
        <div class="relative py-12 px-4">
            <div class="max-w-6xl mx-auto">
                ...
                <form action="<?php echo e(route('register.with-plan')); ?>" method="POST" id="registrationForm">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/teya2023/Downloads/invoice-saas-starter/resources/views/auth/register-with-plan.blade.php ENDPATH**/ ?>